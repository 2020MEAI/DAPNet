    ...
    for key in tqdm(dict_patient):
        ...
        #     pass
            ...
            for icd_item in disease_statastic_dict:
                # icd1=dict_icd_num[icd_item]
                # num1=disease_statastic_dict[icd_item]
                # num2=matrix[icd1]
...
def build_features_data(pre_dis_list):
    ...
    # icd_list,dict_icd_num=construct_icd_list('../data/total_network.csv')
    new_str = '_'.join(pre_dis_list).replace('.', '')
...
# nohup python -u bulid_time_data2.py > bulid_time_data2.txt 2>&1 &
